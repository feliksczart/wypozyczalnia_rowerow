CREATE TABLE ROWERY
    ...
    CONSTRAINT FK_SERWIS_ROWERU FOREIGN KEY(ID_SERWISU) REFERENCES SERWIS(ID_SERWISU)
);
...
CREATE TABLE CZARNA_LISTA
    ...
    POWOD VARCHAR2(100), 
    PRIMARY KEY(ID_KLIENTA),
    CONSTRAINT FK_CZARNA_LISTA FOREIGN KEY (ID_KLIENTA) REFERENCES KLIENT(ID_KLIENTA)
);
